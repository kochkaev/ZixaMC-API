    ...
    data class ServerBotDataClass (
        ...
        data class ServerBotIntegration(
            ...
            data class ServerBotGroupConfig(
                val addToChatButton: String = "Добавить в группу 💬",
                val sorryOnlyForPlayer: String = "Извините, но добавлять меня в группы могут только игроки 😔",
                val hello: String = "Привет! Я — бот приватного Minecraft SMP сервера Zixa City!\nЯ очень рад, что вы добавили меня, давайте начнём!",
                val needAgreeWithRules: String = "Для продолжения использования этого бота, владелец чата должен ознакомиться и согласиться с правилами.",
                val agreeWithRules: String = "С правилами ознакомлен и согласен ✅",
                ...
                data class Settings(
                    ...
                    val aliasesDescription: String = "Псевдонимы позволяют добавлять группе \"вторые имена\", с помощью которых можно обращаться к группе также, как и с обычным именем <i>(на пример, использовать в команде /r)</i>",
