...
class SQLChatMemberStatusArray(
    sql: MySQL,
    column: String,
    uniqueId: Long,
    uniqueColumn: String,
): AbstractSQLArray<TgChatMemberStatuses>(
    sql = sql,
    column = column,
    uniqueId = uniqueId,
...
//        .setPrettyPrinting()
        ...
        .serializeNulls()
        .create()
        .fromJson(it, object: TypeToken<List<TgChatMemberStatuses>>(){}.type) },
...
//    fun contains(status: TgChatMemberStatuses?) =
